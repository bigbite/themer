...
//   const { globalStylesId, isReady, settings, styles } = useSelect((select) => {
...
//         ? hasFinishedResolution('getEditedEntityRecord', ['root', 'globalStyles', _globalStylesId])
//         : true;
//     }
...
//   return <GlobalStylesContext.Provider value={context}>{children}</GlobalStylesContext.Provider>;
// }
