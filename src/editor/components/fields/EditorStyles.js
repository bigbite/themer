...
export default function EditorStyles({ styles }) {
  const stylesArray = useMemo(() => Object.values(styles ?? []), [styles]);

  //this function might need to be changed to work with themer object rather than wp object.
  const transformedStyles = useMemo(
    () =>
      transformStyles(
        stylesArray.filter((style) => style),
